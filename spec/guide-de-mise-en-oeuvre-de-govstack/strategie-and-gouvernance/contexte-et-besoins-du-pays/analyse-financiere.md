...
<summary>Phase de découverte : établissement de la ligne de base</summary>

1.  **Évaluation de l'état actuel des lieux.**
...
2. **Estimation des coûts actuels ou du déficit des avantages que vous essayez de faire.** Malgré leur importance, les considérations contextuelles et la mesure du rendement ne sont qu'indirectement associées à "l'estimation des coûts actuels ou du déficit des avantages que vous tentez de faire" .

</details>

<details>

<summary>Phase d'avant-projet : Estimations du rapport coût-efficacité (<a href="https://www.gov.uk/service-manual/measuring-success/measuring-service-benefits">GOV.UK Service Manual</a>)</summary>

1. Estimation des avantages potentiels.
...
<summary>Phase de suivi et d'évaluation</summary>
...
La Digital Impact Alliance a [développé un cadre ](https://procurement.dial.global/category-framework/)qui peut être adopté à cette fin. Au niveau de base :

1. Calculez les coûts et les avantages réels. À partir de ce chiffre, vous pouvez calculer un rapport coûts-avantages, un retour sur investissement, un taux de rendement interne, une valeur actuelle nette et une période de récupération.
2. Identifiez les forces et les faiblesses de votre mise en œuvre et itérez en conséquence
